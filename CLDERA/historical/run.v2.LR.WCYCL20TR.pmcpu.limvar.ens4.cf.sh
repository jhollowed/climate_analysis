...
readonly CASE_NAME="v2.LR.WCYCL20TR.pmcpu.limvar.ens4.cf"
...
fincl3 = 'PV','PV_TRCR','PT','PT_TRCR'
 ...
 ext_frc_specifier              = 'SO2         -> /global/cfs/cdirs/m4014/data/E3SM/model_input/emissions/volc/merge_cmip6_and_volc_so2/modified_emissions/merged_cmip6_and_VolcanEESMv3.11_1989-1998_180x360_counterfactual_c20230210.nc',
