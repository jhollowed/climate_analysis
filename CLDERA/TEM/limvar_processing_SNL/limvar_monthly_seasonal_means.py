...
This script computes monthly means of limvar TEM data, and limvar zonal means. Some limvar
zonal means will already exist from the h0 history files. These variables will be combined
with variables which only exist as daily data, monthly averaged.
