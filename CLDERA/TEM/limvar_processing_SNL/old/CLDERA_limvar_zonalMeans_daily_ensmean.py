...
# output location
outdir = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_daily_ensmean'
# data location
temloc = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_daily_timeConcat'
...
print('locating data...')
cfstr = ['', '.cf'][int(cf)]
enshist = sorted(glob.glob('{}/*ens[0-9]{}.eam.h1*.nc'.format(temloc, cfstr)))
