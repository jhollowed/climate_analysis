...
# output location
outdir = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_monthly_ttest'
# tem results location
dataloc = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_monthly_impact_ensmean'
...
impactdir = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_monthly_impact'
...
pval = pval.drop_vars(['time', 'lat', 'plev', 'lev'])
