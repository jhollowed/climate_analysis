...
# output location
outdir = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_daily_impact_ensmean'
# tem results location
dataloc = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_daily_impact'
...
# get ensemble data
print('locating data...')
enshist = sorted(glob.glob('{}/*ens*.eam.h1*_impact.nc'.format(dataloc)))
