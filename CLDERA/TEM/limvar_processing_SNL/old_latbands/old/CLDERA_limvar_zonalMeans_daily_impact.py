...
# output location
outdir = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_daily_impact'
# tem results location
dataloc = '/ascldap/users/jphollo/data/limvar/limvar_zonalMeans_daily_timeConcat'
# data location
...
enshist = sorted(glob.glob('{}/*ens{}{}.eam.h1*.nc'.format(dataloc, Nens, '')))[0]
enshistcf = sorted(glob.glob('{}/*ens{}{}.eam.h1*.nc'.format(dataloc, Nens, '.cf')))[0]
fname = enshist
