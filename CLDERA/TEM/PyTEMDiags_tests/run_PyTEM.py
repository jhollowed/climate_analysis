...
gcnc = '/pscratch/sd/j/jhollo/E3SM/historical_data/TEM_test_data/ne30pg2_GridCellAreas.nc'

gcdata = xr.open_dataset(gcnc)
weights = gcdata['AREA'].mean('time')
...
if(do_p_var):
    ...
    tem = PyTEMDiags.TEMDiagnostics(ua, va, ta, wap, p, lat, weights, p0=p0, L=L, 
