...
wd="/global/homes/j/jhollo/repos/climate_analysis/CLDERA/CLOCK"
MY_E3SM_ROOT="/global/homes/j/jhollo/E3SM/CLDERA-E3SM_passive"
MODEL="${MY_E3SM_ROOT}/cime/scripts/create_newcase"

CASES="${wd}/cases"
CASENAME="E3SM_${RES}_L72_${COMPSET}_e90st80"
CASE=${CASES}/${CASENAME}

OUTROOT="/global/cscratch1/sd/jhollo/E3SM/E3SMv2_cases/e90st80_cases"
...
! activate built-in analytic init of cldera passive tracers
