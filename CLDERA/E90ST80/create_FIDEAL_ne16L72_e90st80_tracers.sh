...
wd="/global/homes/j/jhollo/repos/climate_analysis/CLDERA/E90ST80"
MY_E3SM_ROOT="/global/homes/j/jhollo/E3SM/CLDERA-E3SM_ST80fix"
MODEL="${MY_E3SM_ROOT}/cime/scripts/create_newcase"

CASES="${wd}/cases"
CASENAME="HSW_E90ST80_${RES}_L72_${TOT_RUN_LENGTH}day${SUFFIX}"
CASE=${CASES}/${CASENAME}

OUTROOT="/pscratch/sd/j/jhollo/E3SM/E3SMv2_cases/e90st80_cases"
